...
- [UBIAI](https://www.ubiai.tools/) - Easy-to-use text annotation tool for teams with the most comprehensive auto-annotation features. Supports OCR annotation for invoice labeling, costs $
